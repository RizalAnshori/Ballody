...
public abstract class MadLevelAbstractLayout : MadNode {
    ...
    public IconTemplateQuantity iconTemplateQuantity = IconTemplateQuantity.Single;
    ...
    protected void UpdateMultipleIcons() {
        ...
        if (iconTemplateQuantity == IconTemplateQuantity.Single) {
            return;
        }
        ...
        while (iconTemplates.Count < levelCount) {
            MadLevelIcon previous = null;
            if (iconTemplates.Count > 0) {
                previous = iconTemplates[iconTemplates.Count - 1];
            }
            iconTemplates.Add(previous);
