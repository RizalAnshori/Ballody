...
public class MadLevelAbstractLayoutInspector : Editor {
    ...
    protected SerializedProperty iconTemplates;
    protected SerializedProperty iconTemplateQuantity;
    ...
    protected virtual void OnEnable() {
        ...
        iconTemplates = serializedObject.FindProperty("iconTemplates");
        iconTemplateQuantity = serializedObject.FindProperty("iconTemplateQuantity");
